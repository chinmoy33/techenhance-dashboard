...
const ChartView: React.FC<ChartViewProps> = ({
	...
	const analyzeSelectedAttributes = (): {
		...
		// Return counts of numeric and categorical values
			...
			datasets: [
				{
					...
					borderWidth: 2,
					fill: true,
					pointBackgroundColor: chartConfig.colors?.[0]?.replace("0.8", "1"),
					pointBorderColor: "#fff",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: chartConfig.colors?.[0]?.replace("0.8", "1"),
				},
			],
		};
	};
