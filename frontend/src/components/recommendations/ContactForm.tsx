// // // // components/Leadtracking/ContactForm.tsx
...
// // //   return (
// // //     <div className="space-y-3 mb-4 p-4 bg-slate-700 rounded-md">
...
// // //       <input
// // //         type="number"
// // //         placeholder="Final Disbursed Amount"
// // //         className="w-full p-2 rounded bg-slate-800 text-white"
...
// //             setLoading(true);
// //             try {
// //                 await onSubmit(formData); // wait for async handler to finish
// //             } finally {
// //                 setLoading(false);
// //             }
// //             }}
...
//               value={formData.type_of_mutual_fund}
//               onChange={(e) =>
//                 setFormData({ ...formData, type_of_mutual_fund: e.target.value })
//               }
//             >
//               <option value="">Select Mutual Fund Type</option>
//               <option value="SIP">SIP</option>
...
//                 checked={formData.kyc_completed}
//                 onChange={(e) =>
//                   setFormData({ ...formData, kyc_completed: e.target.checked })
//                 }
//               />
//               KYC Completed
//             </label>
...
//       final_amount: +formData.final_amount || 0,
//       final_disbursed_amt: +formData.final_disbursed_amt || 0,
//     };
//     try {
