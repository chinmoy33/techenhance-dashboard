...
//                             {funnelData.stages[0].count > 0
//                                 ? `${((funnelData.stages[3].count / funnelData.stages[0].count) * 100).toFixed(1)}%`
//                                 : '0.0%'
//                             }
//                         </div>
//                     </div>
...
//                         <div className="text-white text-lg font-semibold">
//                             ₹{funnelData.stages[3].amount.toLocaleString()}
//                         </div>
//                     </div>
//                 </div>
//             </div>
    ...
    const calculateFunnelData = () => {
        ...
        return {
            stages: [
                ...
                {
                    label: '3-Close', // Renamed from 4-Close to 3-Close for sequential numbering
                    count: finalDisbursed,
                    amount: disbursedAmount,
                    color: 'rgba(245, 158, 11, 0.8)', // Yellow
                    borderColor: 'rgba(245, 158, 11, 1)'
