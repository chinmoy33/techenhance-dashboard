          ...
          >
            ...
            {group.transactions.length > 0 && (
              <>
                ...
                <h3 className="text-lg font-semibold text-green-300 px-4 sm:px-0">Transaction History</h3>
                {/* Changed: Use TransactionTable instead of individual TransactionCard components */}
                <TransactionTable
