      ...
      <div className="space-y-6">
        {currentResults.map((group) => (
          ...
          >
            {group.profile && (
              <>
                <h3 className="text-lg font-semibold text-blue-300 px-4 sm:px-0">Profile Details</h3> {/* Added px-4 for this heading */}
                <ProfileCard
            ...
            {group.transactions.length > 0 && (
              <>
                <h3 className="text-lg font-semibold text-green-300 px-4 sm:px-0">Transaction Details</h3> {/* Added px-4 for this heading */}
